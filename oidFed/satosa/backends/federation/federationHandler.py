...
from oidFed.satosa.backends.federation.commons import DEFAULT_HTTPC_PARAMS
...
from oidFed.satosa.backends.federation.schemas.jwk import JWK
from oidFed.satosa.backends.federation.schemas.jwt.jws_helper import JWSHelper
from oidFed.satosa.backends.federation.schemas.trust.trust_source import (
    TrustEvaluationType,
    TrustSourceData,
)
from oidFed.satosa.backends.federation.statements import get_entity_configurations
from oidFed.satosa.backends.OidFed.trust_chain_validator import (
    StaticTrustChainValidator,
)
from oidFed.satosa.backends.tools.base_logger import BaseLogger
from oidFed.satosa.backends.tools.response import JsonResponse
from oidFed.satosa.backends.tools.utils import decode_jwt_payload, exp_from_now, iat_now
...
class FederationHandler(BaseLogger):
